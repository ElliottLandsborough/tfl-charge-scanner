...
var ChartComponent = function (_React$Component) {
  ...
  ChartComponent.prototype.render = function render() {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement('canvas', {
      ref: this.ref,
      height: height,
      width: width,
      id: id,
...
var Doughnut = function (_React$Component2) {
  ...
  Doughnut.prototype.render = function render() {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(ChartComponent, _extends({}, this.props, {
...
function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_1__["BrowserRouter"], null, react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_Header__WEBPACK_IMPORTED_MODULE_2__["default"], null), react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_1__["Switch"], null, react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_1__["Route"], {
        exact: true,
        path: "/",
...
react__WEBPACK_IMPORTED_MODULE_0__["default"].render(react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(App, null), document.getElementById('app'));

/***/ }),

/***/ "./resources/js/components/GraphAmounts.js":
/*!*************************************************!*\
  !*** ./resources/js/components/GraphAmounts.js ***!
  \*************************************************/
/*! exports provided: default */
...
/*#__PURE__*/
function (_Component) {
  _inherits(GraphAmounts, _Component);

  _createClass(GraphAmounts, [{
  ...
  function GraphAmounts(props) {
    _classCallCheck(this, GraphAmounts);

    return _possibleConstructorReturn(this, _getPrototypeOf(GraphAmounts).call(this, props));
  }
  ...
  _createClass(GraphAmounts, [{
    ...
    key: "barChartData",
    value: function barChartData() {
      var self = this;
      var labelDates = Object.keys(this.props.yearMonths);
      var labels = [];
      var monzoPayments = [];
      var tflPrices = [];
      var clubPrices = [];
      var yealyAmount = (self.props.yearlyAmount / 12).toFixed(2);
      var clubAmount = (self.props.clubAmount / 12).toFixed(2);
      labelDates.forEach(function (value) {
        var parsedDate = value.toString().substr(0, 4) + '-' + value.toString().substr(4, 2) + "-01";
        var date = date_fns_format__WEBPACK_IMPORTED_MODULE_2___default()(date_fns_parse__WEBPACK_IMPORTED_MODULE_3___default()(parsedDate), 'MMM YYYY');
        labels.push(date);
    ...
    key: "render",
    value: function render() {
      var chartData = this.barChartData();
      var chartOptions = {
        scales: {
          yAxes: [{
            display: true,
      ...
      }, react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(react_chartjs_2__WEBPACK_IMPORTED_MODULE_1__["Bar"], {
        data: chartData,
...
/* harmony default export */ __webpack_exports__["default"] = (GraphAmounts);
...
var Header = function Header() {
  return react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("nav", {
...
/* harmony import */ var _GraphAmounts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./GraphAmounts */ "./resources/js/components/GraphAmounts.js");
/* harmony import */ var _TflAmount__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./TflAmount */ "./resources/js/components/TflAmount.js");
/* harmony import */ var _Loader__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Loader */ "./resources/js/components/Loader.js");
/* harmony import */ var date_fns_sub_months__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! date-fns/sub_months */ "./node_modules/date-fns/sub_months/index.js");
/* harmony import */ var date_fns_sub_months__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(date_fns_sub_months__WEBPACK_IMPORTED_MODULE_6__);
...
/* harmony import */ var date_fns_difference_in_days__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! date-fns/difference_in_days */ "./node_modules/date-fns/difference_in_days/index.js");
/* harmony import */ var date_fns_difference_in_days__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(date_fns_difference_in_days__WEBPACK_IMPORTED_MODULE_9__);
...
function (_Component) {
  ...
  function Example(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Example).call(this, props)); // set the initial state

    _this.state = _this.initialState(); // bind 'this' to a few functions

    _this.setFromZone = _this.setFromZone.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.setToZone = _this.setToZone.bind(_assertThisInitialized(_assertThisInitialized(_this)));
  ...
  _createClass(Example, [{
    ...
    value: function initialState() {
      return {
        ...
        isAuthorized: false,
        // becomes true if an auth token exists
        accessToken: false,
        // the access token returned from the api
        accounts: [],
        // the accounts returned by the api
        accountId: false,
        // the 'retail_uk' account id
        transactionsForTravel: [],
        // transactions used for TFL travel
        travelTransactionsLastDate: false,
        // the date of the most recent transaction
        yearAverages: [],
        // yearly average monzo spend
        yearTotals: [],
        // yearly total monzo spend
        yearMonths: [],
        // monthly total monzo spend
        fromZone: 0,
        // current 'from' zone from dropdowns
        toZone: 0,
        // current 'to' zone from dropdowns
        yearlyAmount: 0,
        // current yearly tfl price based on dropdowns
        clubAmount: 0,
        // current commuterclub price based on dropdowns
        sinceDate: false,
        // when to count transactions from
        loadingIsComplete: false,
        // becomes true when transaction loop finishes
    ...
    value: function getYearlyAmount() {
      ...
      var amount = 0,
          array,
          amounts = this.getTflAmounts(); // if start is higher than finish, switch the vars around
    ...
    key: "calculateCommuterClub",
    value: function calculateCommuterClub(yearlyAmount) {
    ...
    value: function componentDidMount() {
      ...
      this.setAmounts(); // initialize auth, get an access token from laravel
    ...
    key: "initializeAuthentication",
    value: function initializeAuthentication() {
      var _this2 = this;

      fetch("/credentials").then(function (res) {
        return res.json();
      }).then(function (result) {
        var howManyItems = Object.keys(result).length;
      ...
      }).then(function (howManyItems) {
        if (howManyItems) {
          // If yes, query the api for an account id
          _this2.fetchAccountId();
        }
      });
    }
    /**
    ...
    key: "fetchAccountId",
    value: function fetchAccountId() {
      var _this3 = this;

      var monzoApi = this.state.monzoApi;
      var self = this;
      fetch(monzoApi + '/accounts', this.authParams()).then(function (response) {
        ...
        _this3.setRetailAccountId();
      }).then(function () {
        // success, try to get transactions from api
        _this3.populateTransactions();
      });
    }
    /**
    ...
    key: "setRetailAccountId",
    value: function setRetailAccountId() {
    ...
    key: "setSinceDate",
    value: function setSinceDate() {
      // subtract 12 months
      var sinceObject = date_fns_sub_months__WEBPACK_IMPORTED_MODULE_6___default()(new Date(), 12); // format it

      var since = date_fns_format__WEBPACK_IMPORTED_MODULE_7___default()(sinceObject, 'YYYY-MM') + '-01T00:00:00Z';
      this.setState({
        sinceDate: since
      });
    }
  }, {
    key: "generateTransactionUrl",
    value: function generateTransactionUrl() {
      var since = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
      var _this$state = this.state,
          monzoApi = _this$state.monzoApi,
    ...
    key: "getDaysPercentage",
    value: function getDaysPercentage() {
      ...
      if (this.state.sinceDate !== false && this.state.transactionsForTravel.length) {
        ...
        var lastDateString = this.state.transactionsForTravel[this.state.transactionsForTravel.length - 1].created; // day count between now and when we started querying the api

        var fromStartUntilNow = date_fns_difference_in_days__WEBPACK_IMPORTED_MODULE_9___default()(new Date(), // now
        date_fns_parse__WEBPACK_IMPORTED_MODULE_8___default()(this.state.sinceDate) // date we start querying api from
        ); // day count between when we started querying the api and the last thing the api returned

        var fromstartUntilLast = date_fns_difference_in_days__WEBPACK_IMPORTED_MODULE_9___default()(date_fns_parse__WEBPACK_IMPORTED_MODULE_8___default()(lastDateString), // last date from list of transactions (string)
        date_fns_parse__WEBPACK_IMPORTED_MODULE_8___default()(this.state.sinceDate) // date we start querying api from
        ); // calc percentage

        var percentage = Math.round(fromstartUntilLast / fromStartUntilNow * 100);
        return percentage;
      }
    ...
    key: "getMonzoMonthlyAverage",
    value: function getMonzoMonthlyAverage() {
      // convert the full total to a positive number of pounds/pence
      var fullTotal = this.state.fullTotal * -1 / 100; // only bother if a start date was set and the total is bigger than 0

      if (this.state.sinceDate !== false && fullTotal > 0) {
        // average number of days in a month including leaps
        var daysInMonth = 30.44; // how many days exist between start and now?

        var fromStartUntilNow1 = date_fns_difference_in_days__WEBPACK_IMPORTED_MODULE_9___default()(new Date(), date_fns_parse__WEBPACK_IMPORTED_MODULE_8___default()(this.state.sinceDate)); // and this equates to how many months (e.g 12.76)

        var exactMonths = fromStartUntilNow1 / daysInMonth; // the total equates to this much per month
    ...
    value: function populateTransactions() {
      this.setSinceDate();
      var usedTxKeys = []; // get the transactions from localstorage and update state with them

      if (localStorage.getItem('travelTransactions')) {
        var travelTransactionsFromStorage = JSON.parse(localStorage.getItem('travelTransactions'));
        this.setState({
      ...
      var self = this; // TODO: handle the 401 here, probably clear the credentials
      // and set the state back to isAuthorized: false, clear the old creds

      var transactionsLoop =
      /*#__PURE__*/
      function () {
        var _ref2 = _asyncToGenerator(
        /*#__PURE__*/
        _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
          var continueLoop, lastDate, response, json, transactions;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  continueLoop = true;
                  lastDate = self.state.travelTransactionsLastDate;
                ...
                case 2:
                  ...
                  _context.next = 5;
                  return fetch(self.generateTransactionUrl(lastDate), self.authParams());
                ...
                case 8:
                  json = _context.sent;
                  transactions = json.transactions; // so just get transport ones
                  ...
                  transactions.forEach(function (transaction) {
                    if (transaction.category == 'transport' && transaction.description.toLowerCase().includes('tfl.gov.uk') && transaction.account_id == self.state.accountId) {
                      ...
                      if (!usedTxKeys.includes(transaction.id)) {
                        self.setState({
                          transactionsForTravel: [].concat(_toConsumableArray(self.state.transactionsForTravel), [{
        ...
        return function transactionsLoop() {
    ...
    key: "storeTravelTransactions",
    value: function storeTravelTransactions() {
    ...
    key: "travelTotals",
    value: function travelTotals() {
      // some defaults
      var yearAverages = {};
      var yearTotals = {};
      var yearMonths = {};
      var fullTotal = 0; // loop through all transactions

      this.state.transactionsForTravel.forEach(function (transaction) {
        var amount = transaction.amount;
        var month = transaction.created.substr(5, 2);
        var year = transaction.created.substr(0, 4); // total per year, initialize as 0 if it doesnt exist yet

        if (typeof yearTotals[year] == "undefined") yearTotals[year] = 0;
        yearTotals[year] += amount; // average per year, initialize as 0 if it doesnt exist yet

        if (typeof yearAverages[year] == "undefined") yearAverages[year] = 0;
        yearAverages[year] += Math.round(amount / 12); // total per yearMonth initialize as 0 if it doesnt exist yet

        if (typeof yearMonths['' + year + month] == "undefined") yearMonths['' + year + month] = 0;
        yearMonths['' + year + month] += amount; // total of everything
    ...
    key: "setAmounts",
    value: function setAmounts() {
      var fromZone = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
      var toZone = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 3;
      var yearlyAmount = this.getYearlyAmount(fromZone, toZone);
      var clubAmount = this.calculateCommuterClub(yearlyAmount);
      this.setState({
        fromZone: fromZone,
        toZone: toZone,
    ...
    value: function logOut() {
      ...
      this.setState(this.initialState()); // clear localstorage
    ...
    value: function render() {
      var _this$state2 = this.state,
          ...
          isAuthorized = _this$state2.isAuthorized,
          items = _this$state2.items,
          travelTotals = _this$state2.travelTotals;

      if (error) {
        return react__WEBPACK_IMPORTED_MODULE_1__["default"].createElement("div", null, "Error: ", error.message);
      } else if (!isAuthorized) {
        return react__WEBPACK_IMPORTED_MODULE_1__["default"].createElement("a", {
          className: "auth-button",
          href: "/auth"
        }, "Authorize with Monzo");
      } else {
        var tflZones = [1, 2, 3, 4, 5, 6, 7, 8, 9].map(function (num) {
          return react__WEBPACK_IMPORTED_MODULE_1__["default"].createElement("option", {
            key: num,
            value: num
          }, num);
        });
        return react__WEBPACK_IMPORTED_MODULE_1__["default"].createElement("div", null, react__WEBPACK_IMPORTED_MODULE_1__["default"].createElement(_Loader__WEBPACK_IMPORTED_MODULE_5__["default"], {
          daysPercentage: this.getDaysPercentage(),
          loadingIsComplete: this.state.loadingIsComplete
        }), react__WEBPACK_IMPORTED_MODULE_1__["default"].createElement(_GraphAmounts__WEBPACK_IMPORTED_MODULE_3__["default"], {
          yearlyAmount: this.state.yearlyAmount,
          clubAmount: this.state.clubAmount,
          yearMonths: this.state.yearMonths
        }), react__WEBPACK_IMPORTED_MODULE_1__["default"].createElement("div", {
          className: "zone-selector"
        }, "From zone", react__WEBPACK_IMPORTED_MODULE_1__["default"].createElement("select", {
          id: "zoneFromSelector",
          className: "form-control",
          onChange: this.setFromZone,
          value: this.state.fromZone
        }, tflZones), "to zone", react__WEBPACK_IMPORTED_MODULE_1__["default"].createElement("select", {
          id: "zoneToSelector",
          className: "form-control",
          onChange: this.setToZone,
          value: this.state.toZone
        }, tflZones)), react__WEBPACK_IMPORTED_MODULE_1__["default"].createElement("div", {
          className: "tfl-amount"
        }, react__WEBPACK_IMPORTED_MODULE_1__["default"].createElement(_TflAmount__WEBPACK_IMPORTED_MODULE_4__["default"], {
          yearlyAmount: this.state.yearlyAmount,
          clubAmount: this.state.clubAmount,
          monzoMonthlyAverage: this.getMonzoMonthlyAverage()
        })), react__WEBPACK_IMPORTED_MODULE_1__["default"].createElement("div", {
          className: "log-out"
        }, react__WEBPACK_IMPORTED_MODULE_1__["default"].createElement("button", {
          className: "logout",
          onClick: this.logOut
        }, "Logout")));
      }
...
function (_Component) {
  ...
  _createClass(Loader, [{
    key: "render",
    value: function render() {
      var percentage = this.props.daysPercentage;
      var loadingIsComplete = this.props.loadingIsComplete;
      var style = {
        width: percentage + '%',
...
function (_Component) {
  ...
  _createClass(TflAmount, [{
    key: "render",
    value: function render() {
      var yearlyAmount = this.props.yearlyAmount;
      var perMonth = yearlyAmount / 12;
      var clubAmount = this.props.clubAmount;
      var clubPerMonth = clubAmount / 12;
      return react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
        className: "amount-info"
      }, react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("b", null, "TFL:"), " \xA3", yearlyAmount.toFixed(2), " (\xA3", perMonth.toFixed(2), "/m)"), react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
        className: "amount-info"
      }, react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("b", null, "Commuter Club:"), " \xA3", clubAmount.toFixed(2), " (\xA3", clubPerMonth.toFixed(2), "/m)"), react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
        className: "amount-info"
      }, react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("b", null, "Average Monzo Cost:"), " \xA3", this.props.monzoMonthlyAverage, "/m"));
    }
  }]);
...
__webpack_require__(/*! /home/elliott/projects/monzo-balance/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/elliott/projects/monzo-balance/resources/sass/app.scss */"./resources/sass/app.scss");
